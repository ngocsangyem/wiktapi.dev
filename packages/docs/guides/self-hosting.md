...
Run your own Wordictapi instance with a single SQLite file. No external services required.
...
vp run @wordictapi/api#import

# Import a single edition
vp run @wordictapi/api#import -- --edition en

# Drop and recreate the table first (clean import)
vp run @wordictapi/api#import -- --edition en --fresh
```
...
vp run @wordictapi/api#import -- --edition fr
```
